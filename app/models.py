...
class User(UserMixin, db.Model):
    ...
    member_since=db.Column(db.DateTime(),default=datetime.utcnow)#function can be given. will be invoked bySQLAlchemy
...
class Post(db.Model):
    ...
    @staticmethod
    def on_changed_body(target,value,oldvalue,unitiator):
